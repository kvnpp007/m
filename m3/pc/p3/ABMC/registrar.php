				...
				<div class="row">
                    ...
                    <?php
                        if(isset($_REQUEST['id'])) {
                            echo "Identificador: ".$_REQUEST['Clave']. "<br>";
                        }
                        echo "Descripción: ".$_REQUEST['Descripcion']."<br>";
                        echo "Moneda: ".$_REQUEST['Moneda']."<br>";
                        echo "Precio: ".$_REQUEST['Precio']."<br>";
                        $Clave=$_REQUEST['Clave'];
                        $Descripcion=$_REQUEST['Descripcion'];
                        $Moneda=$_REQUEST['Moneda'];
                        $Precio=$_REQUEST['Precio'];
                        $sql = "INSERT INTO consumible VALUES('$Clave','$Descripcion','$Moneda','$Precio')";
