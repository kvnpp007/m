<!-- Archivo de funciones para conexión,consulta y borrado y edición de elementos -->
<?php
function conectar()
{
 	$user = "root";					//Función que ya contabamos con ella donde establecemos una conexión con la base de datos
	$server = "localhost";
	$pass = "";
	$db = "biblioteca";
	$conexion = mysqli_connect($server, $user, $pass, $db) or die ("error en la conexion");
 	mysqli_set_charset($conexion,"utf8");   //opcional para la lectura de caracteres
	return $conexion;
}
